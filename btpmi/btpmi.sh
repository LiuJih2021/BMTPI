...
then
    ...
    $dir/01_methylation_filter.sh $METHYLATIONCSV $METHYLATIONGFF $METHYLATIONTYPE $undermethylation_threshold $identification $coverag
####################################QC####################################
...
do
    ...
    mv "$motifgff"* ./unmethylation/"$motifgff"unmethylation_CDS
    read -u6
    {
