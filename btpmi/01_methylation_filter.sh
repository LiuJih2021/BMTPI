...
for motif in `cat motifs.sorted.delete.tsv`
do
        less "$motif"_"$3"_motif|awk -F'\t' '{print $4"\t"$9}'|sed 's/;/\t/g'|awk '{print $1"\t"$5"\t"$10}'|sed 's/identificationQv=//g'|awk '{if($3>"'$5'"-1)print $0}'|sed 's/coverage=//g' |awk '{if($2> "'$coverage'")print $1}'> "$motif"_"$3"_motif_methylation.gff.bed
done
...
for motif in `cat motifs.sorted.delete.tsv`
do
        less "$motif"_"$3"_motif|awk -F'\t' '{print $4"\t"$9}'|sed 's/;/\t/g'|awk '{print $1"\t"$5"\t"$9"\t"$10}'|sed 's/identificationQv=//g'|awk '{if($4>"'$5'"-1)print $0}'|sed 's/frac=//g' |awk '{if($3<"'$4'")print $0}' |sed 's/coverage=//g' |awk '{if($2> 30)print $1}'> "$motif"_"$3"_motif_undermethylation.gff.bed
done
...
for motif in `cat motifs.sorted.delete.tsv`
do
        less "$motif"_"$3"_motif|awk -F'\t' '{print $4"\t"$9}'|sed 's/;/\t/g'|awk '{print $1"\t"$5"\t"$9"\t"$10}'|sed 's/identificationQv=//g'|awk '{if($4<"'$5'")print $0}'|sed 's/frac=//g' |sed 's/coverage=//g' |awk '{if($2< "'$coverage'"+1)print $1}'> "$motif"_"$3"_motif_unmethylation.gff.bed
done
